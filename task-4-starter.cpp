...
/*
Check Quantity: After selling the items, we check if the item's quantity reaches zero.
Delete and Shift: If the quantity is zero, we delete the item from the array and shift the remaining items to fill the gap.
Decrease item_count: We also decrease the item_count to reflect the removal of the item.
*/
